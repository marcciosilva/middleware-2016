...
public class AnulacionReserva implements IAnulacionReserva {
	...
	public String AnularReserva(@WebParam(name = "idConfirmacionPago") long idConfirmacionPago,
		...
		if (pago != null) {
			// Si el pago ya fue anulado retorno el mismo id de confirmaci贸n de
			// anulaci贸n
			...
			if (idMedioPago == 1000) {
				...
				System.out.println("El id de anulaci髇 es " + idconfAnulacionPagoStr);
				return idconfAnulacionPagoStr;				
				...
				String idConfirmacionPagoStr = String.valueOf(idConfirmacionPago);
				pagosYa.anularPago(idConfirmacionPagoStr);
				Pago.contadorIdConfAnulacionLocal++;
				pago.idConfAnulacionPago = Pago.contadorIdConfAnulacionLocal;
				String idconfAnulacionPagoStr = String.valueOf(pago.idConfAnulacionPago);
		...
		for (Reserva r : reservas) {
			try {
				...
				for (Horario h : horarios) {
					...
					// ArrayList<Disponibilidad> disponibilidadesModificar =
					// horarioModificar.disponibilidades;
